...
#define _nstates2	39	/* Clock */
#define minseq2	113
#define maxseq2	150
#define _endstate2	38

#define _nstates1	99	/* Receiver */
#define minseq1	15
#define maxseq1	112
#define _endstate1	98

#define _nstates0	16	/* Sender */
#define minseq0	0
#define maxseq0	14
...
#define PClock	((P2 *)_this)
typedef struct P2 { /* Clock */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, _6_5_ack_seq) - 1*sizeof(uchar))
...
#endif
	uchar current_time;
	uchar next_seq_to_send;
	uchar packets_sent;
	uchar next_expected_seq;
	uchar packets_received;
	uchar packets_acked;
	uchar delayed_segments;
	uchar last_recv_time;
	uchar iat_curr;
	uchar last_iat_reset_time;
	uchar ack_scheduled;
	uchar ack_timer_expiry;
	uchar network_chan;
	uchar ack_chan;
	short iat_min;
	short ato;
...
#define HAS_TRACK	0
/* hidden variable: */	uchar quick_ack_mode;
/* hidden variable: */	uchar out_of_order;
